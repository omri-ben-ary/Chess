...
#define OUR_PATH_LEVEL "./player_levels_your_output.txt"
#define OUR_PATH_STATS "./tournament_statistics_your_output.txt"
...
//    char* our_path_stats = "tests/tournament_statistics_your_output.txt";
    ...
    ASSERT_TEST(chessSavePlayersLevels(chess2, file_levels) == CHESS_SUCCESS);
    ASSERT_TEST(chessSaveTournamentStatistics(chess2, "./tournament_statistics_your_output.txt") == CHESS_SUCCESS);
