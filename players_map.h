...
/**
 * playersMapGetWins : get number of wins of a given player
...
/**
 * playersMapGetTies : get number of ties of a given player
...
/**
 * playersMapGetLoses : get number of loses of a given player
