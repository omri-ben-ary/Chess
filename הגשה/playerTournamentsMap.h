...
*/
PlayerTournamentStatsResult playerTournamentsHistoryTablePut(PlayerTournamentsHistoryTable tournaments_table,
                             TournamentID tournament_id, PlayerTournamentStats tournament_stats);
